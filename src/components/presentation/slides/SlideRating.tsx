    ...
    <div className="flex h-full">
      ...
      <div className="w-[50%] px-[120px] py-[100px] flex flex-col justify-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
          <span className="text-[18px] font-semibold uppercase tracking-[6px] text-accent/80">Конкурентное преимущество</span>
          <h2 className="text-[56px] font-bold mt-4 leading-tight">
            Система рейтинга —<br />
        ...
        >
          <div className="card-glass rounded-2xl p-8">
            <h3 className="text-[24px] font-semibold mb-3">🔒 Одновременная публикация</h3>
          ...
          <div className="card-glass rounded-2xl p-8">
            <h3 className="text-[24px] font-semibold mb-3">📊 Байесовский рейтинг</h3>
            <p className="text-[18px] text-muted-foreground leading-relaxed">
              Новички получают рейтинг 5.0 с весом 2 — защита от случайного одного негативного отзыва
            </p>
          </div>
          <div className="card-glass rounded-2xl p-8">
            <h3 className="text-[24px] font-semibold mb-3">♻️ Персистентность</h3>
            <p className="text-[18px] text-muted-foreground leading-relaxed">
      ...
      <div className="w-[50%] flex flex-col items-center justify-center px-16 relative">
        ...
        >
          <h3 className="text-[28px] font-semibold text-center mb-6">Теги оценки</h3>
          
          <div>
            <p className="text-[16px] uppercase tracking-[4px] text-primary/60 mb-4">Позитивные</p>
            <div className="flex flex-wrap gap-3">
              {["Соответствует фото", "Интересный собеседник", "Пунктуальность", "Вежливость", "Опрятный вид", "Харизма"].map((t, i) => (
                <motion.span
                  ...
                  className="bg-primary/15 text-primary px-6 py-3 rounded-2xl text-[18px] font-medium"
                >
                  ✅ {t}
                </motion.span>
              ))}
          ...
          <div>
            <p className="text-[16px] uppercase tracking-[4px] text-destructive/60 mb-4">Негативные</p>
            <div className="flex flex-wrap gap-3">
              {["Не соответствует фото", "Скука", "Опоздание", "Токсичность", "Постоянно в телефоне"].map((t, i) => (
                <motion.span
                  ...
                  className="bg-destructive/15 text-destructive px-6 py-3 rounded-2xl text-[18px] font-medium"
                >
                  ❌ {t}
                </motion.span>
              ))}
