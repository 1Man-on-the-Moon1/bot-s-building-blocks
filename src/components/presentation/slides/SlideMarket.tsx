  ...
  <SlideLayout>
    <div className="flex flex-col h-full px-[120px] py-[100px]">
      <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }}>
        <span className="text-[18px] font-semibold uppercase tracking-[6px] text-primary/80">Рынок</span>
        <h2 className="text-[64px] font-bold mt-4 text-gradient-primary">Целевой рынок</h2>
      </motion.div>
      ...
      <div className="grid grid-cols-4 gap-8 mt-16">
        {stats.map((s, i) => (
          ...
          >
            <span className="text-[56px] font-bold text-gradient-warm">{s.value}</span>
            <p className="text-[22px] font-semibold mt-4">{s.label}</p>
            <p className="text-[16px] text-muted-foreground mt-2">{s.sub}</p>
          </motion.div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 gap-8 mt-12 flex-1">
        ...
        >
          <h3 className="text-[28px] font-semibold mb-6">🎯 Почему Telegram-бот?</h3>
          <ul className="space-y-4 text-[20px] text-muted-foreground">
        ...
        <motion.div
          ...
          className="card-glass rounded-3xl p-10"
        >
          <h3 className="text-[28px] font-semibold mb-6">🏆 Конкуренты</h3>
          <ul className="space-y-4 text-[20px] text-muted-foreground">
          ...
          <p className="text-[18px] text-primary mt-6 font-semibold">
