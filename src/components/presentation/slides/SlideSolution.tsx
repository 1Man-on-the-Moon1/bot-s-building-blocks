    ...
    <div className="flex h-full">
      ...
      <div className="w-[55%] px-[120px] py-[100px] flex flex-col justify-center">
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
          <span className="text-[22px] font-semibold uppercase tracking-[6px] text-accent/80">Решение</span>
          <h2 className="text-[80px] font-bold mt-4 leading-tight">
            <span className="text-gradient-warm">CITRAMON DATING</span>
          </h2>
          <p className="text-[32px] text-muted-foreground mt-6 leading-relaxed max-w-[700px]">
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="flex items-center gap-4 text-[26px]"
            >
      ...
      <div className="w-[45%] flex items-center justify-center relative">
        ...
        <motion.div
          ...
          className="relative card-glass rounded-3xl p-12 w-[520px] glow-primary"
        >
          <div className="text-center mb-8">
            <div className="text-[80px] mb-4">👤</div>
            <h3 className="text-[40px] font-bold">Алиса, 24</h3>
            <p className="text-[22px] text-muted-foreground">Минск · Кофе, Путешествия</p>
          </div>
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="text-[36px]">⭐</span>
            <span className="text-[44px] font-bold text-gradient-warm">4.8</span>
            <span className="text-[20px] text-muted-foreground">(12 отзывов)</span>
          </div>
